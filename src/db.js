...
const SystemSettingsSchema = new mongoose.Schema({
  ...
  hospital_wifi_ips: { type: String, default: '["120.61.26.70", "120.61.26.0/24", "103.170.54.239", "103.170.54.0/24", "103.15.22.4", "103.15.22.5"]' },
  ...
  if (useRealMongo) {
    ...
    if (!existingSettings) {
      await models.SystemSettings.create({
        ...
        hospital_wifi_ips: '["120.61.26.70", "120.61.26.0/24", "103.170.54.239", "103.170.54.0/24", "103.15.22.4", "103.15.22.5"]',
