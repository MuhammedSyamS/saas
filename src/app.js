...
function isApprovedHospitalNetwork(clientIp, allowedIpsInput) {
  ...
  if (!allowedList || allowedList.length === 0) {
    allowedList = ['120.61.26.70', '120.61.26.0/24', '103.170.54.239', '103.170.54.0/24', '103.15.22.4', '103.15.22.5'];
  }
...
function evaluatePhysicalPresence({ clientIp, location, settings }) {
  const allowedIps = (settings && settings.hospital_wifi_ips) || process.env.HOSPITAL_ALLOWED_PUBLIC_IPS || ['120.61.26.70', '120.61.26.0/24', '103.170.54.239', '103.170.54.0/24', '103.15.22.4', '103.15.22.5'];
